...
export default function AudioFilter({ filterCallback }) {
  ...
  const categories = ['All', 'Culture', 'Technology', 'Education', 'Society'];
  ...
  const handleListItemClick = (field, data, key) => {
    ...
    window.location.assign(
      `/radios/c=${chosen.category}/y=${chosen.year}/a=${chosen.area}/l=${chosen.language}`
    );
  };
